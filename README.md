...
This project builds on public Colmi smart-ring research, BLE notes, and MIDI
examples from:

- Aaron Christophel / [atc1441](https://github.com/atc1441) for public
  smart-ring hardware notes, OTA firmware context, and prior work on faster raw
  motion data.
...
Those projects and references remain under their own licences and terms. This
repository does not vendor their code or assets; they are credited here as
references that helped make this tool possible.
