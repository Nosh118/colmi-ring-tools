...
repository license. Firmware binaries are different.

The included `.bin` files are firmware artifacts for Colmi / QRing smart rings.
...
If a rights holder asks for a firmware artifact to be removed, remove the binary
